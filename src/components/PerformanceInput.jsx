    ...
    return (
      <div
        className={classNames(
          "text-[#828282]  border rounded focus-within:text-blue-500 focus-within:hover:border-blue-500 focus-within:ring-1  focus-within:border-blue-500 focus:border-blue-500  py-1 h-[50px] w-[225px] items-center hover:border-tertiary default-transition relative flex   border-gray-400",
          {
