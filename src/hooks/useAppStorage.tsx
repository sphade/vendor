...
// Create Config
localforage.config({
  name: "BossBus vendor Dashboard",
  storeName: "bossBus_Vendor_dashboard", // Should be alphanumeric, with underscores.
  description: "Storage site for Bossbus vendor dashboard",
});
